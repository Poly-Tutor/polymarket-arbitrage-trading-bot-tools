...
If you already have the folder (`bots/btc-binary-VWAP-Momentum-bot`), **cd** into it:

```bash
cd "path/to/polymarket-arbitrage-trading-bot-tools/bots/btc-binary-VWAP-Momentum-bot"
```
